...
# Aliased: the contract suite reads MODEL_ID/REVISION off every model in MODELS.
MODEL_ID = HELPER_MODEL
...
TURN_SUFFIX = "<start_of_turn>model\n"

# Declared: Gemma-3 has no reasoning mode, so nothing it emits can be a leak.
REASONING_MARKERS = ()
